-- MultiCourse Learning Platform - Supabase Database Schema (Fixed Version)
...
-- Triggers to automatically update updated_at (DROP IF EXISTS first to avoid conflicts)
...
-- FIXED: Using auth.jwt() to check for admin role instead of querying users table
